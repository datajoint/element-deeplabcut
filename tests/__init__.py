...
def sessions_csv():
    ...
    session_content = ["subject,session_datetime,session_dir,session_note",
                       ...
                       "subject6,2021-06-02 14:04:22,example-dir/subject6/,"
...
def recordings_csv():
    ...
    recording_content = ["recording_id,subject,session_datetime,recording_start_time,"
...
def config_params_csv():
    ...
    config_params_content = ["paramset_idx,paramset_desc,config_path,shuffle,"
                             + "trainingsetindex,filter_type,track_method,"
                             + "scorer_legacy,maxiters",
                             "1,OpenField,openfield-Pranav-2018-10-30/config.yaml,1,0,,"
                             + ",False,5",
                             "2,Reaching,Reaching-Mackenzie-2018-08-30/config.yaml,1,0,"
                             + ",,False,5",
                             "3,ExtraExample,Example/config.yaml,0,0,median,ellipse,"
                             + "False,1"
                             ]
...
@pytest.fixture
def ingest_dlc_items(ingest_subjects, ingest_sessions,
                     recordings_csv, config_params_csv):
    ...
    ingest_dlc_items(config_params_csv_path=config_params_csv_path,
